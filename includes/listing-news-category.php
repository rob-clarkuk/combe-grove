...
<?php
    ...
    $buildCats = getUriSegment(1);
    if($buildCats == "news"){
        $buildCats = "news, things-to-do-in-bath, uncategorised";
    } else if($buildCats == "whats-on-in-bath"){
        $buildCats = "whats-on-in-bath, whats-on-at-combe-grove";
    } else if($buildCats == "club-news"){
        $buildCats = "club-news, club-events";
    } else {
        $buildCats = getUriSegment(1);
    }
...
<?php else: ?>
        <li>
            <div class="layout__inner--center">
